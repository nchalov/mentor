...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int sumInDate = orders.stream().filter(date -> date.getOrderDate().getMonthValue() == 2)
        ...
        int sum = products.stream().mapToInt(price -> price.getPrice().intValue()).sum();
        int max = products.stream().mapToInt(price -> price.getPrice().intValue()).max().getAsInt();
        int min = products.stream().mapToInt(price -> price.getPrice().intValue()).min().getAsInt();
        double average = products.stream().mapToDouble(price -> price.getPrice().doubleValue()).average().getAsDouble();
